...
public class DBService {
	...
	public void instantiateTestDatabase() throws Exception {
		...
		Produto p4 = new Produto(null, "Mesa de Escritório", 300.00d);
		Produto p5 = new Produto(null, "Toalha", 50.00d);
		Produto p6 = new Produto(null, "Colcha", 200.00d);
		Produto p7 = new Produto(null, "TV True Color", 1200.00d);
		Produto p8 = new Produto(null, "Roçadeira", 800.00d);
		Produto p9 = new Produto(null, "Abajour", 100.00d);
		Produto p10 = new Produto(null, "Pendente", 180.00d);
		Produto p11 = new Produto(null, "Shampoo", 90.00d);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rodrigojsoliveira@gmail.com", "76382976522",
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("minhaSenha"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, null, dataVencimento.getCalendar(),
				null);
		...
		p1.getItensPedido().add(ip1);
		p2.getItensPedido().add(ip3);
		p3.getItensPedido().add(ip2);
